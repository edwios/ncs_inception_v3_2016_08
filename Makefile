...
MODEL_FILENAME = output/inception_v3_2016_08.pb
# META_FILENAME = output/inception_v3_2016_08.meta
#CONV_SCRIPT = ./inception-v3.py
CONV_PB_SCRIPT = ./ckpt2pb.py

INPUT_NODE_FLAG = -in=import/input
#OUTPUT_NODE_FLAG = -on=InceptionV3/Predictions/Reshape_1
#OUTPUT_NODE_FLAG = -on=InceptionV3/Predictions/Softmax
OUTPUT_NODE_FLAG = -on=import/multi-predictions
...
#	test -f ${MODEL_FILENAME} || (${CONV_SCRIPT})
	test -f ${MODEL_FILENAME} || (${CONV_PB_SCRIPT})
